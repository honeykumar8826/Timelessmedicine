...
class OilMainUsageAdapter(
    val context: Context,
    val oilMainUsageList: ArrayList<AllData>
) : RecyclerView.Adapter<OilMainUsageAdapter.OilMainUsageViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): OilMainUsageViewHolder {

        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.custom_layout_main_area_usage, parent, false)
        return OilMainUsageViewHolder(view)
    }
    ...
    override fun onBindViewHolder(holder: OilMainUsageViewHolder, position: Int) {
    ...
    inner class OilMainUsageViewHolder(view: View) : RecyclerView.ViewHolder(view) {
