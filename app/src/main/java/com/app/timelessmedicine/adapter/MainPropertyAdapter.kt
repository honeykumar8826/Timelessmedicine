...
class MainPropertyAdapter(val context: Context, val mainPropertyList: ArrayList<CommonNameTypeBean>) :
    RecyclerView.Adapter<MainPropertyAdapter.MainPropertyViewHolder>() {
